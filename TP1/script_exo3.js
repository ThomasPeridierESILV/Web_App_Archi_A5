...
function load3()
{
	var display = document.getElementById('text3');
	display.innerHTML = "";
	var data = {
	  "cars": [
	    {
	...
	for (var i = 0; i < rentals.length; i++) {
		...
		for (var j = 0; j < cars.length; j++) {
			...
			if(car.id == idCar)
			{
				...
				display.innerHTML += "<tr><td>" + firstname + "</td><td>" + name + "</td><td>" + vehicule + "</td><td>" + finalPrice + "</td><td>" +  Commission.insurance + "</td><td>" + Commission.assistance + "</td><td>" + Commission.drivy + "</td></tr>";
			}
		};
		console.log(rental);
	};
